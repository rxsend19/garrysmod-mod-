...
resource.AddFile( "materials/effect/balloon001.vmt" )
resource.AddFile( "materials/effect/heart.vmt" )
resource.AddFile( "sound/effect/balloon_pop.wav" )

CSR = CSR or {}
CSR.Balloons = false

util.AddNetworkString("__")
util.AddNetworkString("_")
