...
-- 	bullet.Callback	= function ( a, b, c ) BulletPenetration( 0, a, b, c ) end 	-- CALL THE FUNCTION BULLETPENETRATION
	...
	if trace.Entity:GetClass() == "prop_door_rotating" and self.mode == "burst" and (SERVER) and CSR.BreakDoors:GetBool() then
		...
		timer.Simple(0.01, function() ent:SetVelocity(push) end)               
		timer.Simple(0.01, function() ent:GetPhysicsObject():ApplyForceCenter(push) end)
		timer.Simple(25, function() trace.Entity:ResetDoor(ent) end)
	end
end